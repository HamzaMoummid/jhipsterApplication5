...
public class JhipsterApplication5App {

    private static final Logger log = LoggerFactory.getLogger(JhipsterApplication5App.class);

    private final Environment env;

    public JhipsterApplication5App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterApplication5.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterApplication5App.class);
